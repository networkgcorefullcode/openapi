...
func (o *TmgiRange) UnmarshalJSON(data []byte) (err error) {
	...
	varTmgiRange := _TmgiRange{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varTmgiRange)

	if err != nil {
		return err
	}

	*o = TmgiRange(varTmgiRange)
