...
type _SnssaiMbSmfInfoItem SnssaiMbSmfInfoItem
...
func (o *SnssaiMbSmfInfoItem) UnmarshalJSON(data []byte) (err error) {
	...
	varSnssaiMbSmfInfoItem := _SnssaiMbSmfInfoItem{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varSnssaiMbSmfInfoItem)

	if err != nil {
		return err
	}

	*o = SnssaiMbSmfInfoItem(varSnssaiMbSmfInfoItem)
