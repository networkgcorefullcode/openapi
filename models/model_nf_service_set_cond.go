...
type _NfServiceSetCond NfServiceSetCond
...
func (o *NfServiceSetCond) UnmarshalJSON(data []byte) (err error) {
	...
	varNfServiceSetCond := _NfServiceSetCond{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varNfServiceSetCond)

	if err != nil {
		return err
	}

	*o = NfServiceSetCond(varNfServiceSetCond)
