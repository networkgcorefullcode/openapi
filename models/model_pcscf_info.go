...
// PcscfInfo represents P-CSCF information
type PcscfInfo struct {
	...
	ServingPlmns []PlmnId `json:"servingPlmns,omitempty"`
}
...
// GetServingPlmns returns the ServingPlmns field value if set, zero value otherwise.
func (o *PcscfInfo) GetServingPlmns() []PlmnId {
	if o == nil || IsNil(o.ServingPlmns) {
		var ret []PlmnId
		return ret
	}
	return o.ServingPlmns
}

// GetServingPlmnsOk returns a tuple with the ServingPlmns field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *PcscfInfo) GetServingPlmnsOk() ([]PlmnId, bool) {
	if o == nil || IsNil(o.ServingPlmns) {
		return nil, false
	}
	return o.ServingPlmns, true
}
...
// SetServingPlmns gets a reference to the given []PlmnId and assigns it to the ServingPlmns field.
...
func (o PcscfInfo) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.ServingPlmns) {
		toSerialize["servingPlmns"] = o.ServingPlmns
	}
