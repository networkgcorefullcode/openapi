...
type UdrInfo struct {
	...
	SharedDataIdRanges             []SharedDataIdRange `json:"sharedDataIdRanges,omitempty" yaml:"sharedDataIdRanges" bson:"sharedDataIdRanges" mapstructure:"SharedDataIdRanges"`
}
