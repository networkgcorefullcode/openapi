...
type _NFProfileRegistrationError NFProfileRegistrationError
...
func (o NFProfileRegistrationError) MarshalJSON() ([]byte, error) {
...
func (o NFProfileRegistrationError) ToMap() (map[string]interface{}, error) {
...
func (o *NFProfileRegistrationError) UnmarshalJSON(data []byte) (err error) {
	...
	varNFProfileRegistrationError := _NFProfileRegistrationError{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varNFProfileRegistrationError)

	if err != nil {
		return err
	}

	*o = NFProfileRegistrationError(varNFProfileRegistrationError)
