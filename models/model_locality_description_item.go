...
type _LocalityDescriptionItem LocalityDescriptionItem
...
func (o *LocalityDescriptionItem) UnmarshalJSON(data []byte) (err error) {
	...
	varLocalityDescriptionItem := _LocalityDescriptionItem{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varLocalityDescriptionItem)

	if err != nil {
		return err
	}

	*o = LocalityDescriptionItem(varLocalityDescriptionItem)
