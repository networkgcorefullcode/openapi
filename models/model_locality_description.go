...
func (o *LocalityDescription) UnmarshalJSON(data []byte) (err error) {
	...
	varLocalityDescription := _LocalityDescription{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varLocalityDescription)

	if err != nil {
		return err
	}

	*o = LocalityDescription(varLocalityDescription)
