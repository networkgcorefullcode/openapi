...
type _NfGroupListCond NfGroupListCond
...
func (o *NfGroupListCond) UnmarshalJSON(data []byte) (err error) {
	...
	varNfGroupListCond := _NfGroupListCond{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varNfGroupListCond)

	if err != nil {
		return err
	}

	*o = NfGroupListCond(varNfGroupListCond)
