...
func (o *MbUpfInfo) UnmarshalJSON(data []byte) (err error) {
	...
	varMbUpfInfo := _MbUpfInfo{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varMbUpfInfo)

	if err != nil {
		return err
	}

	*o = MbUpfInfo(varMbUpfInfo)
