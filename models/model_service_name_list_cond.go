...
type _ServiceNameListCond ServiceNameListCond
...
func (o *ServiceNameListCond) UnmarshalJSON(data []byte) (err error) {
	...
	varServiceNameListCond := _ServiceNameListCond{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varServiceNameListCond)

	if err != nil {
		return err
	}

	*o = ServiceNameListCond(varServiceNameListCond)
