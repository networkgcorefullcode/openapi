...
func (o *SubscriptionContext) UnmarshalJSON(data []byte) (err error) {
	...
	varSubscriptionContext := _SubscriptionContext{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varSubscriptionContext)

	if err != nil {
		return err
	}

	*o = SubscriptionContext(varSubscriptionContext)
