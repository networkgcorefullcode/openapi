...
func (o *SnssaiEasdfInfoItem) UnmarshalJSON(data []byte) (err error) {
	...
	varSnssaiEasdfInfoItem := _SnssaiEasdfInfoItem{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varSnssaiEasdfInfoItem)

	if err != nil {
		return err
	}

	*o = SnssaiEasdfInfoItem(varSnssaiEasdfInfoItem)
