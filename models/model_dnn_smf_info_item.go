...
func (o *DnnSmfInfoItem) UnmarshalJSON(data []byte) (err error) {
	...
	varDnnSmfInfoItem := _DnnSmfInfoItem{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varDnnSmfInfoItem)

	if err != nil {
		return err
	}

	*o = DnnSmfInfoItem(varDnnSmfInfoItem)
