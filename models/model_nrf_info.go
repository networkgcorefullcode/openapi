...
// GetServedDcsfInfo returns the ServedDcsfInfo field value if set, zero value otherwise.
func (o *NrfInfo) GetServedDcsfInfo() map[string]DcsfInfo {
	if o == nil || IsNil(o.ServedDcsfInfo) {
		var ret map[string]DcsfInfo
		return ret
	}
	return *o.ServedDcsfInfo
}

// GetServedDcsfInfoOk returns a tuple with the ServedDcsfInfo field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *NrfInfo) GetServedDcsfInfoOk() (*map[string]DcsfInfo, bool) {
	if o == nil || IsNil(o.ServedDcsfInfo) {
		return nil, false
	}
	return o.ServedDcsfInfo, true
}
...
// SetServedDcsfInfo gets a reference to the given map[string]DcsfInfo and assigns it to the ServedDcsfInfo field.
func (o *NrfInfo) SetServedDcsfInfo(v map[string]DcsfInfo) {
	o.ServedDcsfInfo = &v
}

// GetServedMfInfo returns the ServedMfInfo field value if set, zero value otherwise.
func (o *NrfInfo) GetServedMfInfo() map[string]MfInfo {
	if o == nil || IsNil(o.ServedMfInfo) {
		var ret map[string]MfInfo
		return ret
	}
	return *o.ServedMfInfo
}

// GetServedMfInfoOk returns a tuple with the ServedMfInfo field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *NrfInfo) GetServedMfInfoOk() (*map[string]MfInfo, bool) {
	if o == nil || IsNil(o.ServedMfInfo) {
		return nil, false
	}
	return o.ServedMfInfo, true
}
...
// SetServedMfInfo gets a reference to the given map[string]MfInfo and assigns it to the ServedMfInfo field.
func (o *NrfInfo) SetServedMfInfo(v map[string]MfInfo) {
	o.ServedMfInfo = &v
}

// GetServedMrfInfo returns the ServedMrfInfo field value if set, zero value otherwise.
func (o *NrfInfo) GetServedMrfInfo() map[string]MrfInfo {
	if o == nil || IsNil(o.ServedMrfInfo) {
		var ret map[string]MrfInfo
		return ret
	}
	return *o.ServedMrfInfo
}

// GetServedMrfInfoOk returns a tuple with the ServedMrfInfo field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *NrfInfo) GetServedMrfInfoOk() (*map[string]MrfInfo, bool) {
	if o == nil || IsNil(o.ServedMrfInfo) {
		return nil, false
	}
	return o.ServedMrfInfo, true
}
...
// SetServedMrfInfo gets a reference to the given map[string]MrfInfo and assigns it to the ServedMrfInfo field.
func (o *NrfInfo) SetServedMrfInfo(v map[string]MrfInfo) {
	o.ServedMrfInfo = &v
}

// GetServedMrfpInfo returns the ServedMrfpInfo field value if set, zero value otherwise.
func (o *NrfInfo) GetServedMrfpInfo() map[string]MrfpInfo {
	if o == nil || IsNil(o.ServedMrfpInfo) {
		var ret map[string]MrfpInfo
		return ret
	}
	return *o.ServedMrfpInfo
}

// GetServedMrfpInfoOk returns a tuple with the ServedMrfpInfo field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *NrfInfo) GetServedMrfpInfoOk() (*map[string]MrfpInfo, bool) {
	if o == nil || IsNil(o.ServedMrfpInfo) {
		return nil, false
	}
	return o.ServedMrfpInfo, true
}
...
// SetServedMrfpInfo gets a reference to the given map[string]MrfpInfo and assigns it to the ServedMrfpInfo field.
func (o *NrfInfo) SetServedMrfpInfo(v map[string]MrfpInfo) {
	o.ServedMrfpInfo = &v
}

// GetServedImsasInfo returns the ServedImsasInfo field value if set, zero value otherwise.
func (o *NrfInfo) GetServedImsasInfo() map[string]ImsasInfo {
	if o == nil || IsNil(o.ServedImsasInfo) {
		var ret map[string]ImsasInfo
		return ret
	}
	return *o.ServedImsasInfo
}

// GetServedImsasInfoOk returns a tuple with the ServedImsasInfo field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *NrfInfo) GetServedImsasInfoOk() (*map[string]ImsasInfo, bool) {
	if o == nil || IsNil(o.ServedImsasInfo) {
		return nil, false
	}
	return o.ServedImsasInfo, true
}
...
// SetServedImsasInfo gets a reference to the given map[string]ImsasInfo and assigns it to the ServedImsasInfo field.
...
func (o NrfInfo) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.ServedDcsfInfo) {
		toSerialize["servedDcsfInfo"] = o.ServedDcsfInfo
	}
	if !IsNil(o.ServedMfInfo) {
		toSerialize["servedMfInfo"] = o.ServedMfInfo
	}
	if !IsNil(o.ServedMrfInfo) {
		toSerialize["servedMrfInfo"] = o.ServedMrfInfo
	}
	if !IsNil(o.ServedMrfpInfo) {
		toSerialize["servedMrfpInfo"] = o.ServedMrfpInfo
	}
	if !IsNil(o.ServedImsasInfo) {
		toSerialize["servedImsasInfo"] = o.ServedImsasInfo
	}
