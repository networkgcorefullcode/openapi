...
func (dst *EventId) UnmarshalJSON(data []byte) error {
	...
	if err := json.Unmarshal(data, &s); err != nil {
		return fmt.Errorf("data failed to unmarshal into EventId: %w", err)
	}
	*dst = EventId(s)
	return nil
}
