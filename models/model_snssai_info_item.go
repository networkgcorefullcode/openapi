...
func (o *SnssaiInfoItem) UnmarshalJSON(data []byte) (err error) {
	...
	varSnssaiInfoItem := _SnssaiInfoItem{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varSnssaiInfoItem)

	if err != nil {
		return err
	}

	*o = SnssaiInfoItem(varSnssaiInfoItem)
