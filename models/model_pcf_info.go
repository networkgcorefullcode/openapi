...
func (o *PcfInfo) GetA2xSupportInd() bool {
	if o == nil || IsNil(o.A2xSupportInd) {
		var ret bool
		return ret
	}
...
func (o *PcfInfo) GetA2xCapability() A2xCapability {
	if o == nil || IsNil(o.A2xCapability) {
...
func (o *PcfInfo) GetUrspEpsSupport() bool {
	if o == nil || IsNil(o.UrspEpsSupport) {
		var ret bool
		return ret
	}
...
func (o PcfInfo) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.A2xSupportInd) {
		toSerialize["a2xSupportInd"] = o.A2xSupportInd
	}
	if !IsNil(o.A2xCapability) {
