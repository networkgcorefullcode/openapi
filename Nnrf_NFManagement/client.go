...
// APIClient manages communication with the NRF NFManagement Service API v1.4.0-alpha.2
...
type APIClient struct {
	...
	SharedDataDocumentAPI *SharedDataDocumentAPIService

	SharedDataStoreAPI *SharedDataStoreAPIService
