...
**AnalyticsIds** | Pointer to [**[]NwdafEvent**](NwdafEvent.md) |  | [optional] 
**RequesterInterIndList** | Pointer to [**[]MlModelInterInd**](MlModelInterInd.md) |  | [optional] 
**SourceVendorId** | Pointer to **string** | Vendor ID of the NF Service instance (Private Enterprise Number assigned by IANA) | [optional] 
...
`func (o *AccessTokenReq) GetAnalyticsIds() []NwdafEvent`
...
`func (o *AccessTokenReq) GetSourceVendorIdOk() (*string, bool)`
